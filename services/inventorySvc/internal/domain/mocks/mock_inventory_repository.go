...
func (m *MockInventoryRepository) ListLowStock(ctx context.Context, limit int, offset int) ([]*domain.InventoryItem, error) {
	args := m.Called(ctx, limit, offset)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockInventoryRepository) AdjustStock(ctx context.Context, id string, quantity int32, reason string, performedBy string) error {
	args := m.Called(ctx, id, quantity, reason, performedBy)
	return args.Error(0)
}

func (m *MockInventoryRepository) ReserveStock(ctx context.Context, id string, quantity int32, orderID string) error {
	args := m.Called(ctx, id, quantity, orderID)
	return args.Error(0)
}

func (m *MockInventoryRepository) ReleaseReservation(ctx context.Context, id string, quantity int32, orderID string) error {
	args := m.Called(ctx, id, quantity, orderID)
	return args.Error(0)
}

func (m *MockInventoryRepository) FulfillReservation(ctx context.Context, id string, quantity int32, orderID string) error {
	args := m.Called(ctx, id, quantity, orderID)
	return args.Error(0)
}

func (m *MockInventoryRepository) GetByOrderAndLocation(ctx context.Context, orderID string, locationID string) ([]*domain.InventoryItem, error) {
	args := m.Called(ctx, orderID, locationID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).([]*domain.InventoryItem), args.Error(1)
