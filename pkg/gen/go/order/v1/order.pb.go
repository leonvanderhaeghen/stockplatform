...
const file_order_v1_order_proto_rawDesc = "" +
	...
	"\vCancelOrder\x12\x1c.order.v1.CancelOrderRequest\x1a\x1d.order.v1.CancelOrderResponseB\xa3\x01\n" +
	"\fcom.order.v1B\n" +
	"OrderProtoP\x01ZFgithub.com/leonvanderhaeghen/stockplatform/pkg/gen/go/order/v1;orderv1\xa2\x02\x03OXX\xaa\x02\bOrder.V1\xca\x02\bOrder\\V1\xe2\x02\x14Order\\V1\\GPBMetadata\xea\x02\tOrder::V1b\x06proto3"
